...
class TaskMBRL(pl.LightningModule):
    """
    ...
    def __init__(
        ...
        self.model.make_model_dynamics(model, model.state_dim + self.skill_vector_size, self.action_dim)
        ...
        self.model_target.make_model_dynamics(model, model.state_dim + self.skill_vector_size, self.action_dim)
