...
class CALVINDynSysDataset(Dataset):
    ...
    def normalize(self, x):
        ...
        return (self.norm_range[-1] - self.norm_range[0]) * (x - self.X_mins)/ (self.X_maxs - self.X_mins) + self.norm_range[0]
